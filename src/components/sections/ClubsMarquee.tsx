...
const clubLogos = [
  {
    ...
    hours: "Lun - Ven • soir · mercredi après-midi",
    info: "Boxe anglaise, boxe française, kick, K1, MMA-pancrace et école de boxe dès 6 ans.",
  },
  {
    id: 2,
    ...
    hours: "Lun - Sam • matin, après-midi et soir",
    info: "Berceau du club depuis 1991 : multiboxe, muay thaï, cardio step et section compétition.",
  },
  {
    id: 3,
    ...
    hours: "Lun - Ven • midi et soir",
    info: "Fitness, cross boxing, sport santé et boxe ladies, en plus des cours de combat.",
  },
];
