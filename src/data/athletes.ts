...
export const athletes: Athlete[] = [
  ...
  },
  {
    ...
    imagePosition: "50% 12%",
    description:
      "Surnommée « Gigi », double championne de France de full-contact et championne de France de kick-boxing, membre du Collectif France. Compétitrice du Boxing Club Tours Nord.",
    achievements: [
      "Championne de France full 2026",
      "Vice-championne de France kick 2026",
      "Championne de France full 2025",
      "Vice-championne de France K1 2025",
      "Vice-championne de France kick 2025",
      "Championne de France kick 2024",
      "Membre du Collectif France",
      "18 combats amateurs et pro confondus",
      "Catégorie -60 kg",
    ],
    accent: "#ec4899",
  ...
  },
  {
    ...
    discipline: "K1",
    level: "Compétitrice",
    record: "3 victoires • 1 défaite",
    image: "/images/athletes/gomes-catalina.png",
    imagePosition: "50% 12%",
    description:
      "Surnommée « Catal », championne de France de K1 et de full-contact. Compétitrice du Boxing Club Tours Nord, entraînée par Brian Macé et Noham Cardoso.",
    achievements: [
      "Championne de France K1 et full",
      "4 combats amateurs et pro confondus",
      "Catégorie -48 kg",
    ],
    accent: "#a855f7",
